...
namespace Loja.Pagamento.Dominio.Services
{
    public class PagamentoService : IPagamentoService
    {
        ...
        public async Task<Transacao> RealizarPagamentoPedido(PagamentoPedido pagamentoPedido)
        {
            ...
            var pagamento = new Loja.Pagamento.Dominio.Entidades.Pagamento
            {
                Valor = pagamentoPedido.Total,
            ...
            await _mediatorHandler.PublicarNotificacao(new NotificacaoDominio("pagamento","A operadora recusou o pagamento"));
